				...
				<div class="mobile-menu-nav-menus">
					<div class="mobile-nav-tab mobile-nav-tab-main-menu"
						...
						<ul id="mobile-menu-primary" class="menu__container">
							<li class="menu-item-open-modal-demo-preview menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-330 level-1"><a href="{{ route('home') }}">
									<div class="menu-item-wrap"><span class="menu-item-title">Home</span></div>
								</a></li>
							<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item current_page_item menu-item-40 level-1"><a href="{{ route('theproducts') }}">
									<div class="menu-item-wrap"><span class="menu-item-title">Shop</span></div>
								</a></li>
							<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1112 level-1"><a href="{{ route('cart') }}">
							...
							<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1111 level-1"><a href="{{ route('checkout') }}">
