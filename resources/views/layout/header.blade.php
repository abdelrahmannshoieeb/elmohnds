                    ...
                    <div class="header-above-left header-col-start hide-md">
                        <div class="header-content-inner">
                            <div class="header-info-list">
                                <ul class="info-list">
                                    <li class="info-item">
                                        <a class="info-link" href="https://instagram.com/"><span aria-hidden="true" class="info-icon fab fa-instagram"></span>
                                            <div class="item-info"><span class="info-text">100k Followers</span></div>
                                        </a>
                                    </li>
                                    <li class="info-item">
                                        <a class="info-link" href="https://facebook.com/"><span aria-hidden="true" class="info-icon fab fa-facebook"></span>
                                            <div class="item-info"><span class="info-text">300k Followers</span></div>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="header-above-center header-col-center">
                        <div class="header-content-inner">
                            <div class="header-text">
                                <span class="header-tag">Hot</span><span>✌🏼 Free Express Shipping on orders $200!</span>
                            </div>
                        </div>
                    </div>
                    <div class="header-above-right header-col-end">
                        <div class="header-content-inner">
                            ...
                            <div id="switcher-language-wrapper" class="switcher-language-wrapper wpml">
                                        ...
                                        <li tabindex="0"
                                            ...
                                            <a href="#" class="js-wpml-ls-item-toggle wpml-ls-item-toggle">
                                                <img loading="lazy" class="wpml-ls-flag"
                                                    src="{{ asset('assets/wp-content/themes/minimog-child-demo/assets/images/flags/en-us.png')}}"
                                                    alt="en"
                                                    title="English"
                                                    loading="lazy"
                                                    width="25"
                                            ...
                                            <ul class="wpml-ls-sub-menu">
                                                <li class="wpml-ls-slot-shortcode_actions wpml-ls-item wpml-ls-item-fr">
                                                    <a href="#" class="wpml-ls-link">
                                                        <img loading="lazy" class="wpml-ls-flag"
                                                            src="{{ asset('assets/wp-content/themes/minimog-child-demo/assets/images/flags/fr.png')}}"
                                                            alt="fr"
                                                            title="Français"
                                                            loading="lazy"
                                                            width="35"
                                                ...
                                                <li class="wpml-ls-slot-shortcode_actions wpml-ls-item wpml-ls-item-de wpml-ls-last-item">
                                                    <a href="#" class="wpml-ls-link">
                                                        <img loading="lazy" class="wpml-ls-flag"
                                                            src="{{ asset('assets/wp-content/themes/minimog-child-demo/assets/images/flags/de.png')}}"
                                                            alt="de"
                                                            title="Deutsch"
                                                            loading="lazy"
                                                            width="35"
                                ...
                                <script defer src="data:text/javascript;base64,"></script>
                            </div>
                            ...
                            <div class="currency-switcher-menu-wrap curcy">
                                <ul class="menu currency-switcher-menu woo-multi-currency-menu">
                                    <li class="menu-item-has-children">
                                        ...
                                        <ul class="sub-menu">
                                            <li>
                                                <a href="indexa0dd.html?wmc-currency=EUR"
                                                    class=" currency-switcher-link">
                                                    <span class="currency-text">EUR</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="index0d3d.html?wmc-currency=GBP"
                                                    class=" currency-switcher-link">
